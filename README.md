...
- **Correções na Extração de Dados**: Ajustes na extração de dados dos relatórios para maior precisão e confiabilidade
- **Adição de Links no Excel**: Implementação de links diretos nos arquivos Excel gerados, facilitando a navegação e acesso aos relatórios originais
- **Melhorias na Exportação**: Otimizações no processo de exportação de dados para XLSX com melhor organização e estrutura
- **Correções de Bugs**: Resolução de problemas na geração de planilhas e na extração de informações

### Observação
A versão 1.8 foca em melhorar a experiência do usuário na extração de dados, com correções importantes e a adição de links úteis nos arquivos Excel gerados.

## Versão [1.7 - Correções de Bugs e Estabilidade]

### Novidades e Correções ️
- **Correções na Revisão Geral**: Resolução de bugs críticos no sistema de revisão automática de relatórios
- **Correções de Runtime**: Eliminação de erros de execução que afetavam a estabilidade do sistema
- **Melhoria na Consistência**: Ajustes para garantir maior consistência na revisão automática dos relatórios
- **Otimização de Performance**: Melhorias gerais na performance e estabilidade do sistema

### Observação
A versão 1.7 concentra-se em correções essenciais para garantir a estabilidade e confiabilidade do sistema de revisão automática, eliminando bugs que comprometiam a funcionalidade.

## Versão [1.6 - Revisão Automática e Correções]

### Novidades e Correções ️
- **Sistema de Revisão Automática**: Implementação de funcionalidade para revisão completa de relatórios de forma automática
- **Correções de Bugs Diversos**: Resolução de vários problemas identificados nas versões anteriores
- **Melhorias na Estabilidade**: Ajustes que aumentam a robustez geral do sistema
- **Aprimoramento da Interface**: Melhorias na usabilidade e experiência do usuário

### Observação
A versão 1.6 introduz o sistema de revisão automática de relatórios, uma funcionalidade avançada que automatiza o processo de verificação e correção de dados.

## Versão [1.5 - Melhorias na Revisão e Correções]

### Novidades e Correções ️
- **Aprimoramento do Sistema de Revisão**: Melhorias significativas no sistema de revisão automática de relatórios
- **Correções de Bugs**: Resolução de problemas diversos identificados na versão anterior
- **Melhorias na Precisão**: Ajustes que aumentam a precisão na extração e processamento de dados
- **Otimização de Performance**: Melhorias gerais na performance do sistema

### Observação
A versão 1.5 foca em aprimorar o sistema de revisão automática e corrigir bugs diversos, resultando em maior precisão e estabilidade.
