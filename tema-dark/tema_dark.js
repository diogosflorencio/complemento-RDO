...
const cores = {
    bgPrimary: '#1a1a1a',
    bgSecondary: '#2d2d2d',
    branco: '#313131', // cor do background dos cards, cabeçalhos e aprovações
    textSecondary: '${cores.wefwwfw}ccc',
    textoDropdown: '#fd0404',
    cinza: '#8400ff', // cor dos textos secundários carregando links
    brancoLinhas: '#f1f1f1', // Cor branca linha e background do botão de voltar
    bacodropdown: '#facc00',
    coresDropTexto: '#3507db',
    EraUmazulLa: '#51e71685',
    seila: '#01eeff',
    wefwwfw: '#ff00dd',
    bordasErambrancas: '#461212',

};

function temaDark(isDarkTheme) {
    if(isDarkTheme){
      const styleContent = `.logomarca[data-v-0f6c0e10] {
    text-align: center;
    padding: 15px 0;
    position: relative;
    padding: 15px!important;
    background-color: ${cores.brancoLinhas};
    border-radius: 4px;
    margin-bottom: 15px
}
...
.logomarca .logo-imagem[data-v-0f6c0e10],.logomarca.borda .logo[data-v-0f6c0e10] {
    ...
    border: 1px solid ${cores.bordasErambrancas}!important
}
...
.dropdown .btn .placeholderText[data-v-7b895a57] {
    color: ${cores.textoDropdown};
}

.dropdown .btn[data-v-7b895a57]:focus {
    border-color: ${cores.EraUmazulLa}!important
}

.dropdown.disabled .btn[data-v-7b895a57] {
    background: ${cores.bacodropdown}!important;
    opacity: 1!important
}
...
.ajax-loader .ajax-loader-circle circle[data-v-4abf5a4c] {
    -webkit-animation: ajaxLoadercores-data-v-4abf5a4c 5.6s ease-in-out infinite,ajaxLoaderDash-data-v-4abf5a4c 1.4s ease-in-out infinite;
    animation: ajaxLoadercores-data-v-4abf5a4c 5.6s ease-in-out infinite,ajaxLoaderDash-data-v-4abf5a4c 1.4s ease-in-out infinite;
    stroke-dasharray: 1570;
    stroke-dashoffset: 392.5;
    stroke: ${cores.EraUmazulLa};
    stroke-width: 19;
    fill: none
}

.ajax-loader .ajax-loader-letters path[data-v-4abf5a4c] {
    fill: ${cores.EraUmazulLa}
}
...
@-webkit-keyframes ajaxLoadercores-data-v-4abf5a4c {
    0% {
        stroke: #35ad0e
    }
...
@keyframes ajaxLoadercores-data-v-4abf5a4c {
    0% {
        stroke: #35ad0e
    }
...
.paginacao[data-v-55090d29] {
    padding: 15px;
    border-top: 1px solid ${cores.bordasErambrancas}
}
...
.widgets .box[data-v-2db864ce] {
    border: 1px solid ${cores.bordasErambrancas};
...
.video.upload[data-v-7dacd840] {
    border: 1px solid ${cores.bordasErambrancas};
    background-color: ${cores.wefwwfw}
}
...
.videos a[data-v-112e8b22]:hover {
    color: ${cores.EraUmazulLa}!important
}
...
.signature-pad[data-v-3406ffea] {
    ...
    height: 165px;
    background-color: ${cores.branco};
    border: 1px solid ${cores.wefwwfw}
}
...
.assinaturas .assinatura .imagem[data-v-a1090058] {
    border-bottom: 1px solid ${cores.wefwwfw};
    height: 56px;
    width: 100%;
    padding-bottom: 1px
}
...
.login .left {
    ...
    left: 0;
    bottom: 0;
    background: ${cores.bordasErambrancas};
...
.login .left .body ul li {
    ...
    display: inline-block;
    border: 2px solid ${cores.wefwwfw};
    margin: 0 5px;
    padding: 1px 4px;
    border-radius: 8px
}
...
.form-check-label-bold[data-v-ae940dba] {
    font-weight: 700!important;
    color: ${cores.coresDropTexto};!important
}
...
.btn-copiar[data-v-ae940dba]:hover {
    background-color: ${cores.bordasErambrancas}
}
...
.header[data-v-56107eaf] {
    ...
    z-index: 999!important;
    background: ${cores.branco};
    border-bottom: 1px solid ${cores.bordasErambrancas};
    min-width: 992px
}
...
.box .box-item .obra .imagem[data-v-d7f17f70] {
    ...
    border-bottom: 1px solid ${cores.brancoLinhas};
}
...
.lista ul li .imagem img[data-v-6fb94075] {
    ...
    border-radius: 4px;
    background-color: ${cores.bordasErambrancas};
    border: 1px solid ${cores.brancoLinhas};
}
...
.obra .sidebar-left[data-v-c06fb8a2] {
    ...
    padding-top: 55px;
    border-right: 1px solid ${cores.bordasErambrancas}
}
...
.edicoes[data-v-0ffedba8] {
    font-size: 12px;
    border-bottom: 1px dashed ${cores.bordasErambrancas};
...
.box-videos[data-v-3229c72c] {
    padding: 8px 12px;
    border-left: 1px solid ${cores.wefwwfw};
    border-right: 1px solid ${cores.wefwwfw};
    border-bottom: 1px solid ${cores.wefwwfw}
}
...
.assinatura[data-v-f14ed146] {
    border-top: 1px solid ${cores.wefwwfw};
    text-align: center;
...
.alert.alert-dark[data-v-1708882a] {
    ...
    border-color: ${cores.bordasErambrancas}
}
...
.form .input-group .input-group-text[data-v-3f5864c4]:hover {
    color: ${cores.branco};
    border-color: ${cores.EraUmazulLa};
    background: ${cores.EraUmazulLa}
}
...
.swal2-modal .swal2-buttonswrapper.swal2-loading :not(.swal2-styled).swal2-confirm:after {
    ...
    -webkit-box-shadow: 1px 1px 1px ${cores.branco};;
    box-shadow: 1px 1px 1px ${cores.branco};;
...
.datepicker-dropdown:after {
    ...
    border-bottom: 6px solid ${cores.branco};;
    border-top: 0;
    position: absolute
}
...
.datepicker-dropdown.datepicker-orient-top:after {
    bottom: -6px;
    border-bottom: 0;
    border-top: 6px solid ${cores.branco};
}
...
.datepicker table tr td.today,.datepicker table tr td.today.disabled,.datepicker table tr td.today.disabled:hover,.datepicker table tr td.today:hover {
    ...
    filter: progid:DXImageTransform.Microsoft.gradient(startcorestr="#fdd49a",endcorestr="#fdf59a",GradientType=0);
...
.datepicker table tr td.range.today,.datepicker table tr td.range.today.disabled,.datepicker table tr td.range.today.disabled:hover,.datepicker table tr td.range.today:hover {
    ...
    background-repeat: repeat-x;
    filter: progid:DXImageTransform.Microsoft.gradient(startcorestr="#f3c17a",endcorestr="#f3e97a",GradientType=0);
...
.datepicker table tr td.selected,.datepicker table tr td.selected.disabled,.datepicker table tr td.selected.disabled:hover,.datepicker table tr td.selected:hover {
    ...
    background-repeat: repeat-x;
    filter: progid:DXImageTransform.Microsoft.gradient(startcorestr="#b3b3b3",endcorestr="#808080",GradientType=0);
...
.datepicker table tr td.active,.datepicker table tr td.active.disabled,.datepicker table tr td.active.disabled:hover,.datepicker table tr td.active:hover {
    ...
    background-repeat: repeat-x;
    filter: progid:DXImageTransform.Microsoft.gradient(startcorestr="#08c",endcorestr="#0044cc",GradientType=0);
...
.input-daterange .add-on {
    ...
    line-height: 18px;
    text-align: center;
    text-shadow: 0 1px 0 ${cores.branco};;
    vertical-align: middle;
    background-color: #eee;
    border: 1px solid ${cores.wefwwfw};
    margin-left: -5px;
...
.checkbox-primary input[type=checkbox]:checked+label:before {
    background-color: ${cores.EraUmazulLa};
    border-color: ${cores.EraUmazulLa};
...
.form-control {
    ...
    font-size: 12px!important;
    border: 1px solid ${cores.wefwwfw}!important;
    color: ${cores.seila};
    padding: 0 10px;
    border-radius: 3px!important;
    -webkit-transition: all .3s;
...
input:active,input:focus,select:active,select:focus,textarea:active,textarea:focus {
    border: 1px solid ${cores.EraUmazulLa}!important
}
...
.nav-tabs .nav-item a.active,.nav-tabs .nav-item a:hover {
    border: none;
    color: ${cores.EraUmazulLa};
    border-bottom: 2px solid ${cores.EraUmazulLa}
}
...
.placeholder {
    ...
    background: #f6f7f8;
    background: -webkit-gradient(linear,left top,right top,color-stop(8%,#eee),color-stop(18%,${cores.bordasErambrancas}),color-stop(33%,#eee));
    background: linear-gradient(90deg,#eee 8%,${cores.bordasErambrancas} 18%,#eee 33%);
